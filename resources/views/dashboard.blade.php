...
<body class="bg-neutral-950 p-8 min-h-screen text-gray-100 flex items-center justify-center">
    <div class="max-w-4xl w-full bg-neutral-900 p-8 rounded-2xl shadow-2xl border border-purple-900/40 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('pelanggan.index') }}" class="relative block p-6 bg-neutral-950/50 hover:bg-purple-950/30 border border-purple-900/40 hover:border-purple-500 rounded-xl transition duration-300 group">
            ...
            <a href="{{ route('kendaraan.index') }}" class="relative block p-6 bg-neutral-950/50 hover:bg-purple-950/30 border border-purple-900/40 hover:border-purple-500 rounded-xl transition duration-300 group">
                <span class="absolute top-3 right-3 bg-purple-700 text-white text-[10px] font-black px-2 py-0.5 rounded-md tracking-wider">ADMIN</span>
                <div class="text-4xl mb-3 group-hover:scale-110 transition duration-300">🚗</div>
            ...
            <a href="{{ route('servis.index') }}" class="relative block p-6 bg-neutral-950/50 hover:bg-purple-950/30 border border-purple-900/40 hover:border-purple-500 rounded-xl transition duration-300 group">
