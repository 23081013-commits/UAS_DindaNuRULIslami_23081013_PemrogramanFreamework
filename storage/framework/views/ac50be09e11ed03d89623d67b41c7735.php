    ...
    <div class="max-w-4xl mx-auto bg-neutral-900 p-6 rounded-2xl shadow-xl border border-purple-900/40">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mb-6 border-b border-purple-900/60 pb-4">
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('kendaraan.index')); ?>" class="text-purple-400 font-bold border-b-2 border-purple-400 pb-1 text-sm">Data Kendaraan</a>
        ...
        <form action="<?php echo e(route('kendaraan.store')); ?>" method="POST" class="mb-8 bg-neutral-955/60 p-5 rounded-xl border border-purple-900/40">
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select name="pelanggan_id" required class="mt-1 block w-full rounded-lg bg-neutral-900 border border-purple-900/60 text-white p-2.5 focus:border-purple-500 focus:outline-none text-sm cursor-pointer">
                        ...
                        <?php $__currentLoopData = $pelanggans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelanggan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pelanggan->id); ?>" class="bg-neutral-900"><?php echo e($pelanggan->nama_pelanggan); ?> (ID: <?php echo e($pelanggan->id); ?>)</option>
        ...
        <div class="overflow-x-auto rounded-xl border border-neutral-800">
            <table class="min-w-full divide-y divide-neutral-800">
                ...
                <tbody class="bg-neutral-900/40 divide-y divide-neutral-800">
                    <?php $__empty_1 = true; $__currentLoopData = $kendaraans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-neutral-800/30 transition">
                            <td class="px-6 py-4 text-sm font-bold text-white"><?php echo e($k->no_polisi); ?></td>
                            <td class="px-6 py-4 text-sm text-neutral-300"><?php echo e($k->pelanggan->nama_pelanggan); ?></td>
                            <td class="px-6 py-4 text-sm text-neutral-300"><?php echo e($k->merk_kendaraan); ?> <?php echo e($k->model_tipe); ?></td>
                            <td class="px-6 py-4 text-sm text-neutral-400"><?php echo e($k->tahun_produksi ?? '-'); ?></td>
                        </tr>
...
</html><?php /**PATH D:\laragon\www\assignment-bengkel\resources\views/kendaraan/index.blade.php ENDPATH**/ ?>